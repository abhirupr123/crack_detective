      ...
      <Container maxW="container.lg" py={12}>
        <VStack spacing={8}>
            <Box textAlign="center">
                <Heading size="xl" mb={4}>Dimension Measurement Results</Heading>
                <Text color="gray.400">View the calculated dimensions of the object.</Text>
            </Box>
            ...
            >
                {isLoading ? (
                    <VStack>
                        ...
                        <Text mt={4} color="gray.400">Processing dimensions...</Text>
                    </VStack>
                ) : resultImage ? (
                    <VStack spacing={6} w="full">
                        <Image src={resultImage} alt="Measurement Result" maxH="600px" objectFit="contain" rounded="lg" shadow="2xl" />
                         <Button
